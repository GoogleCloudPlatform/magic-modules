module github.com/GoogleCloudPlatform/magic-modules/tpgtools/handwritten
...
require (
	...
	github.com/hashicorp/terraform-provider-google v1.20.1-0.20231113222601-e981ec3cd87f
)
