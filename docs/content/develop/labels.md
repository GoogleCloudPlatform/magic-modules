---
title: "Add Labels and Annotations support"
weight: 70
---
...
### DCL resources
No manual changes are needed. The provider default labels and new labels model will be applied to the resources with top level `labels` field automatically.
...
### DCL resources
No manual changes are needed. The new annotations model will be applied to the resources with top level `annotations` field automatically.
