...
> In the old `examples` block, any key placed under `vars` was automatically appended with a random suffix (e.g. `example-topic-12345`). If you wanted to pass a plain value (without random suffixes), you had to use `test_vars_overrides`.
>
