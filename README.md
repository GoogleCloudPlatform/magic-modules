...
Magic Modules is a tool used to generate Google Cloud Platform support in a variety of open source declarative tools. [GCP "resource"](https://cloud.google.com/docs/overview/#gcp_resources)
