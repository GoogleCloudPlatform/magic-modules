...
# them.
if $(echo $USER | fgrep -wq -e megan07 -e slevenick -e c2thorn -e rileykarson -e melinath -e ScottSuarez -e shuyama1 -e SarahFrench -e roaks3 -e zli82016); then
...
if [[ "$ASSIGNEE" == "null"  || -z "$ASSIGNEE" ]] ; then
  ...
  do
    ...
    if $(echo $reviewer | fgrep -wq -e rileykarson -e slevenick -e c2thorn -e melinath -e ScottSuarez -e shuyama1 -e megan07 -e roaks3 -e SarahFrench -e zli82016); then
