...
func TestExecTestTGC(t *testing.T) {
	...
	expected := [][]any{{"test-tgc.yml", map[string]any{"tpgbbranch": "auto-pr-pr1", "tgcbranch": "auto-pr-pr1", "owner": "modular-magician", "repo": "terraform-google-conversion", "sha": "sha1"}}}
