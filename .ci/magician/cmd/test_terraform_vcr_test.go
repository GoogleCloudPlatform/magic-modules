	...
	tests := []struct {
		...
		},
		{
			...
			wantContains: []string{
				...
				"",
				"",
				color("red", "Tests were added that are GA-only additions and [require manual runs:](https://googlecloudplatform.github.io/magic-modules/test/run-tests/#run-automated-tests)"),
				"- ga-1",
				"- ga-2",
			},
		},
