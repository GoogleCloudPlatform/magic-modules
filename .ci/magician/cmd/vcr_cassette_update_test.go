		...
		},
		{
			...
			expectedCalls: map[string][]ParameterList{
				"Run": {
					...
					{"/mock/dir/magic-modules/.ci/magician", "gcloud", []string{"storage", "cp", "--recursive", "--content-type=text/plain", "--quiet", "/mock/dir/magic-modules/.ci/magician/testlogs/recording_test.log", "gs://vcr-nightly/beta/2024-07-08/buildID/logs/recording/"}, map[string]string(nil)},
					{"/mock/dir/magic-modules/.ci/magician", "gcloud", []string{"storage", "cp", "--recursive", "--content-type=text/plain", "--quiet", "/mock/dir/magic-modules/.ci/magician/testlogs/recording/beta/*", "gs://vcr-nightly/beta/2024-07-08/buildID/logs/build-log/"}, map[string]string(nil)},
