	...
	}{
		{
			...
			expectedCalls: map[string][]ParameterList{
				"Run": {
					...
					{"/mock/dir/magic-modules/.ci/magician", "gcloud", []string{"storage", "cp", "--content-type=text/plain", "--quiet", "--recursive", "/mock/dir/magic-modules/.ci/magician/testlogs/replaying_test.log", "gs://vcr-nightly/beta/2024-07-08/buildID/logs/replaying/"}, map[string]string(nil)},
					{"/mock/dir/magic-modules/.ci/magician", "gcloud", []string{"storage", "cp", "--content-type=text/plain", "--quiet", "--recursive", "/mock/dir/magic-modules/.ci/magician/testlogs/replaying/beta/*", "gs://vcr-nightly/beta/2024-07-08/buildID/logs/build-log/"}, map[string]string(nil)},
				},
			},
		},
		{
			...
			expectedCalls: map[string][]ParameterList{
				"Run": {
					...
					{"/mock/dir/magic-modules/.ci/magician", "gcloud", []string{"storage", "cp", "--recursive", "--content-type=text/plain", "--quiet", "/mock/dir/magic-modules/.ci/magician/testlogs/replaying_test.log", "gs://vcr-nightly/beta/2024-07-08/buildID/logs/replaying/"}, map[string]string(nil)},
					{"/mock/dir/magic-modules/.ci/magician", "gcloud", []string{"storage", "cp", "--recursive", "--content-type:text/plain", "--quiet", "/mock/dir/magic-modules/.ci/magician/testlogs/replaying/beta/*", "gs://vcr-nightly/beta/2024-07-08/buildID/logs/build-log/"}, map[string]string(nil)},
					// record
					{"gopath/src/github.com/hashicorp/terraform-provider-google-beta", "go", []string{"list", "./..."}, map[string]string(nil)},
					...
					{"/mock/dir/magic-modules/.ci/magician", "gcloud", []string{"storage", "cp", "--content-type=text/plain", "--quiet", "--recursive", "/mock/dir/magic-modules/.ci/magician/testlogs/recording_test.log", "gs://vcr-nightly/beta/2024-07-08/buildID/logs/recording/"}, map[string]string(nil)},
					{"/mock/dir/magic-modules/.ci/magician", "gcloud", []string{"storage", "cp", "--content-type=text/plain", "--quiet", "--recursive", "/mock/dir/magic-modules/.ci/magician/testlogs/recording/beta/*", "gs://vcr-nightly/beta/2024-07-08/buildID/logs/build-log/"}, map[string]string(nil)},
					{"/mock/dir/magic-modules/.ci/magician", "gcloud", []string{"storage", "cp", "--quiet", "/mock/dir/magic-modules/.ci/magician/cassettes/beta/*", "gs://ci-vcr-cassettes/beta/fixtures/"}, map[string]string(nil)},
				},
			},
		},
	}
