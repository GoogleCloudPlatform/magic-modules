...
First, check their state: `git fetch origin && git rev-parse origin/tpg-sync origin/tpgb-sync origin/tf-cloud-docs-sync origin/tf-oics-sync origin/tf-validator-sync` will list the commits for each of the sync tags.
