...
bundle exec compiler -a -e terraform -o "${GOPATH}/src/github.com/terraform-providers/$PROVIDER_NAME/"

if [ "$VERSION" = "beta" ]; then
  bundle exec compiler -v beta -a -e terraform -o "${GOPATH}/src/github.com/terraform-providers/$PROVIDER_NAME/"
fi
