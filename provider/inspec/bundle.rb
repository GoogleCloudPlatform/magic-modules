...
module Provider
  ...
  class InspecBundle < Provider::Core
    # The configuration for the "bundle" module (in inspec.yaml)
    class Config < Provider::Config
      attr_reader :manifest

      def provider
        Provider::InspecBundle
      end

      def validate
        check_property :manifest, Provider::InspecBundle::Manifest
      end
    end

    # A manifest for the "bundle" module
    class Manifest < Provider::Inspec::Manifest
