		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("data.google_projects.my-project", "projects.0.parent"),
					resource.TestCheckResourceAttrSet("data.google_projects.my-project", "projects.0.create_time"),
					resource.TestCheckResourceAttrSet("data.google_projects.my-project", "projects.0.labels"),
				),
			},
		},
	})
