...
func resourceAccessContextManagerGcpUserAccessBindingCreate(d *schema.ResourceData, meta interface{}) error {
	...
	log.Printf("[DEBUG] Creating GcpUserAccessBinding (res): %#v", res)
	...
	d.SetId(id)
	log.Printf("[DEBUG] Creating GcpUserAccessBinding (id): %#v", id)
	...
	log.Printf("[DEBUG] Creating GcpUserAccessBinding (opRes): %#v", opRes)
	if err != nil {
