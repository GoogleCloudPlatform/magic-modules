...
* `resource_policies` (Optional) -- A list of names or self links of resource policies to attach to the instance. Modifying this list will cause the instance to recreate.
