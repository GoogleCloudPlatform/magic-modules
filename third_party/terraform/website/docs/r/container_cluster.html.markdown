...
* `node_pool` - (Optional) List of node pools associated with this cluster.
    ...
    **Warning:** node pools defined inside a cluster can't be changed after creation
    without deleting and recreating the entire cluster. Unless you absolutely need the ability
