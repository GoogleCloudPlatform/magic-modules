...
- `fixing-tgc-resource-or-test-failures` (Phase 4)
- `tgc-fix-handwritten-resources-tests-skill` (Phase 4 - if resource is handwritten)
- `tgc-fix-integration-tests-skill` (Phase 4 - if resource is generated)
- `tgc-build-skill` (Phase 5)
- `tgc-run-integration-tests-skill` (Phase 3 & Phase 6)
