...
func (tgc TerraformGoogleConversionNext) CompileCommonFiles(outputFolder string, products []*api.Product, overridePath string) {
	...
	resourceConverters := map[string]string{
		...
		"pkg/tpgiamresource/iam.go":                      "third_party/terraform/tpgiamresource/iam.go.tmpl",
...
func (tgc TerraformGoogleConversionNext) CopyCommonFiles(outputFolder string, generateCode, generateDocs bool) {
	...
	resourceConverters := map[string]string{
		...
		"pkg/transport/mutexkv.go":                   "third_party/terraform/transport/mutexkv.go",
		...
		"pkg/tpgiamresource/resource_iam_binding.go": "third_party/terraform/tpgiamresource/resource_iam_binding.go",
		"pkg/tpgiamresource/resource_iam_member.go":  "third_party/terraform/tpgiamresource/resource_iam_member.go",
		"pkg/tpgiamresource/resource_iam_policy.go":  "third_party/terraform/tpgiamresource/resource_iam_policy.go",
		"pkg/tpgiamresource/iam_batching.go":         "third_party/terraform/tpgiamresource/iam_batching.go",
