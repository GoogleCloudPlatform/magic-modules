		...
		Steps: []resource.TestStep{
			...
			computeInstanceImportStep("us-central1-a", instanceName, []string{}),
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("google_compute_instance.foobar", "scheduling.0.maintenance_interval", "PERIODIC"),
				),
			},
			computeInstanceImportStep("us-central1-a", instanceName, []string{}),
		},
...
func testAccComputeInstance_maintenance_interval(instance, maintenanceInterval string) string {
	return fmt.Sprintf(`
data "google_compute_image" "my_image" {
  family  = "debian-12"
  project = "debian-cloud"
...
resource "google_compute_instance" "foobar" {
  ...
  scheduling {
    ...
    maintenance_interval = "%%s"
  }
}
`, instance, maintenanceInterval)
}
