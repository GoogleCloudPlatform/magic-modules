...
func TestAccComputeInstanceFromTemplate_maintenance_interval(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccComputeInstanceFromTemplate_maintenance_interval(templateDisk, templateName, instanceName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckComputeInstanceExists(t, resourceName, &instance),
					resource.TestCheckResourceAttr(resourceName, "scheduling.0.maintenance_interval", "PERIODIC"),
...
func testAccComputeInstanceFromTemplate_maintenance_interval(templateDisk, template, instance string) string {
	return fmt.Sprintf(`
data "google_compute_image" "my_image" {
  family  = "debian-11"
  project = "debian-cloud"
