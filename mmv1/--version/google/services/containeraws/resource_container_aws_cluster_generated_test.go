...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/containeraws/resource_container_aws_cluster_generated_test.go.tmpl
//
...
func testAccCheckContainerAwsClusterDestroyProducer(t *testing.T) func(s *terraform.State) error {
	return func(s *terraform.State) error {
		for name, rs := range s.RootModule().Resources {
			...
			client := containeraws.NewDCLContainerAwsClient(config, config.UserAgent, billingProject, 0)
