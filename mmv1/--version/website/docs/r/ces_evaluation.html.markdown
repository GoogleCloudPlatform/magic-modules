...
* `default_variables` -
  (Optional)
  Default variables in JSON object format.
...
* `id` - an identifier for the resource with format `projects/{{project}}/locations/{{location}}/apps/{{app}}/evaluations/{{name}}`
...
```tf
import {
  id = "projects/{{project}}/locations/{{location}}/apps/{{app}}/evaluations/{{name}}"
  to = google_ces_evaluation.default
}
```
...
```
$ terraform import google_ces_evaluation.default projects/{{project}}/locations/{{location}}/apps/{{app}}/evaluations/{{name}}
$ terraform import google_ces_evaluation.default {{project}}/{{location}}/{{app}}/{{name}}
$ terraform import google_ces_evaluation.default {{location}}/{{app}}/{{name}}
```
