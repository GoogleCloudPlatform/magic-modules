...
type Resource struct {
	...
	//If true, resource should be autogenerated as a ephemeral resource
	EphemeralResource *resource.EphemeralResource `yaml:"ephemeral_resource,omitempty"`
...
func (r *Resource) ShouldGenerateEphemeralResource() bool {
	if r.EphemeralResource == nil {
		return false
	}

	return r.EphemeralResource.Generate
}

func (r *Resource) ShouldGenerateEphemeralResourceTest() bool {
	if r.EphemeralResource == nil {
		return false
	}
	return !r.EphemeralResource.ExcludeTest
}
