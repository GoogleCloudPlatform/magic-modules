...
type Type struct {
	...
	diff_suppress_func string // Adds a DiffSuppressFunc to the schema
	state_func         string // Adds a StateFunc to the schema
	...
	ignore_read bool
	validation  bool // Adds a ValidateFunc to the schema
	// Indicates that this is an Array that should have Set diff semantics.
	unordered_list bool

	is_set bool // Uses a Set instead of an Array
	...
	custom_flatten string

	__resource interface{}
