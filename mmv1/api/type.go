...
type Type struct {
	...
	//attr_reader
	DiffSuppressFunc string // Adds a DiffSuppressFunc to the schema

	// attr_reader
	StateFunc string // Adds a StateFunc to the schema
	...
	// attr_reader
	IsSet bool // Uses a Set instead of an Array
