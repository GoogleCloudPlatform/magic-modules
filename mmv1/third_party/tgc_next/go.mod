...
require (
	...
	github.com/hashicorp/terraform-provider-google-beta v1.20.1-0.20260112233543-0d14dacf704d
...
require (
	...
	github.com/GoogleCloudPlatform/terraform-google-conversion/v6 v6.49.0
