...
func (c *ComputeInstanceCai2hclConverter) convertResourceData(asset caiasset.Asset) (*models.TerraformResourceBlock, error) {
	...
	hclData["network_performance_config"] = flattenNetworkPerformanceConfig(typedToMap(instance.NetworkPerformanceConfig))
	...
	hclData["shielded_instance_config"] = flattenShieldedVmConfig(typedToMap(instance.ShieldedInstanceConfig))
	hclData["enable_display"] = flattenEnableDisplay(typedToMap(instance.DisplayDevice))
	...
	hclData["confidential_instance_config"] = flattenConfidentialInstanceConfig(typedToMap(instance.ConfidentialInstanceConfig))
