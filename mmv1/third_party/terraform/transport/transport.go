...
// ListArrayPages performs a GET request against ListURL where the response body is a
// JSON array (not an object with a nested array key). Each element is passed to
// Flattener and then to Callback. Rate-limited responses (HTTP 429) are retried.
