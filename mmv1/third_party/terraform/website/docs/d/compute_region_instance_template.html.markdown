...
* `host_error_timeout_seconds` - [Beta](https://registry.terraform.io/providers/hashicorp/google/latest/docs/guides/provider_versions) Time in seconds for host error detection.
