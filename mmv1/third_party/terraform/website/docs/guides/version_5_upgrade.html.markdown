...
implementation, but can otherwise be safely applied. Also, this change may
result in resource recreation for the immutable resources. We are working on
state upgrades to avoid resource recreation.
