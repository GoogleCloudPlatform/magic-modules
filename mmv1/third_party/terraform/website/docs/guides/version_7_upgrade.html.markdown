...
`instance` has been removed in favor of `instance_name`. It is recommended to upgrade to v6.50.0 and switch from `instance` to `instance_name` in your configuration before upgrading to v7.X
