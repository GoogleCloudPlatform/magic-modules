...
* `params` - (Optional [Beta](https://registry.terraform.io/providers/hashicorp/google/latest/docs/guides/provider_versions)) Input only additional params for instance group manager creation. Structure is [documented below](#nested_params). For more information, see [API](https://cloud.google.com/compute/docs/reference/rest/beta/instanceGroupManagers/insert).
...
* `min_ready_sec` - (Optional, [Beta](https://registry.terraform.io/providers/hashicorp/google/latest/docs/guides/provider_versions)), Minimum number of seconds to wait for after a newly created instance becomes available. This value must be from range [0, 3600]
...
* `on_repair` - (Optional, [Beta](https://registry.terraform.io/providers/hashicorp/google/latest/docs/guides/provider_versions)), Configuration for VM repairs in the MIG. Structure is [documented below](#nested_on_repair).
- - -
...
* `min_cpu_platform` - (Optional [Beta](https://registry.terraform.io/providers/hashicorp/google/latest/docs/guides/provider_versions)), Name of the minimum CPU platform to be used by this instance selection. e.g. "Intel Ice Lake".
* `disks` - (Optional [Beta](https://registry.terraform.io/providers/hashicorp/google/latest/docs/guides/provider_versions)), List of disks to be attached to the instances created from this selection. Structure is [documented below](#nested_disks).
