...
* `member/members` - (Required) Identities that will be granted the privilege in `role`.
  ...
  * **principalSet:{principal}**: Federated identity group. For example, principalSet://iam.googleapis.com/projects/PROJECT_NUMBER/locations/global/workloadIdentityPools/PROJECT_ID.svc.id.goog/namespace/NAMESPACE
