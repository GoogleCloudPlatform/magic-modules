...
* `security_policy` - (Optional, [Beta](https://registry.terraform.io/providers/hashicorp/google/latest/docs/guides/provider_versions)) The resource URL for the security policy associated with this target pool.
