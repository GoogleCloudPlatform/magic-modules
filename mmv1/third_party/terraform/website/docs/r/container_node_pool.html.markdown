...
* `autoscaled_rollout_policy` - (Optional, [Beta](https://registry.terraform.io/providers/hashicorp/google/latest/docs/guides/provider_versions)) Autoscaled rollout policy for blue-green upgrade.
