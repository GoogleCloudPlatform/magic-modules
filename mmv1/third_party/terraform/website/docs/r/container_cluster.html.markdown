...
* `auto_ipam_config` - (Optional) All the information related to Auto IPAM. Structure is [documented below](#auto_ipam_config)

<a name="auto_ipam_config"></a>The auto ipam config supports:
