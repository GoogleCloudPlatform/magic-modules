...
* `managed_opentelemetry_config` - (Optional, [Beta](https://registry.terraform.io/providers/hashicorp/google/latest/docs/guides/provider_versions)) Configuration for the [GKE Managed OpenTelemetry](https://docs.cloud.google.com/kubernetes-engine/docs/concepts/managed-otel-gke) feature. Structure is [documented below](#nested_managed_opentelemetry_config).
...
* `pod_security_policy_config` - (Optional, [Beta](https://registry.terraform.io/providers/hashicorp/google/latest/docs/guides/provider_versions)) Configuration for the
...
* `secret_sync_config` - (Optional, [Beta](https://registry.terraform.io/providers/hashicorp/google/latest/docs/guides/provider_versions)) Configuration for the
...
* `cluster_telemetry` - (Optional, [Beta](https://registry.terraform.io/providers/hashicorp/google/latest/docs/guides/provider_versions)) Configuration for
...
* `protect_config` - (Optional, [Beta](https://registry.terraform.io/providers/hashicorp/google/latest/docs/guides/provider_versions))
...
* `workload_alts_config` - (Optional, [Beta](https://registry.terraform.io/providers/hashicorp/google/latest/docs/guides/provider_versions))
...
* `istio_config` - (Optional, [Beta](https://registry.terraform.io/providers/hashicorp/google/latest/docs/guides/provider_versions)).
...
* `kalm_config` - (Optional, [Beta](https://registry.terraform.io/providers/hashicorp/google/latest/docs/guides/provider_versions)).
...
* `pod_snapshot_config` - (Optional, [Beta](https://registry.terraform.io/providers/hashicorp/google/latest/docs/guides/provider_versions)) The status of the Pod Snapshot addon. It is disabled by default. Set `enabled = true` to enable.
...
* `min_cpu_platform` - (Optional, [Beta](https://registry.terraform.io/providers/hashicorp/google/latest/docs/guides/provider_versions))
...
* `ephemeral_storage_config` - (Optional, [Beta](https://registry.terraform.io/providers/hashicorp/google/latest/docs/guides/provider_versions)) Parameters for the ephemeral storage filesystem. If unspecified, ephemeral storage is backed by the boot disk. Structure is [documented below](#nested_ephemeral_storage_config).
...
* `sandbox_config` - (Optional, [Beta](https://registry.terraform.io/providers/hashicorp/google/latest/docs/guides/provider_versions)) [GKE Sandbox](https://cloud.google.com/kubernetes-engine/docs/how-to/sandbox-pods) configuration. When enabling this feature you must specify `image_type = "COS_CONTAINERD"` and `node_version = "1.12.7-gke.17"` or later to use it.
...
* `enabled` (Required, [Beta](https://registry.terraform.io/providers/hashicorp/google/latest/docs/guides/provider_versions)) - Enable the Sync as K8s secret feature for this cluster.
* `rotation_config` (Optional, [Beta](https://registry.terraform.io/providers/hashicorp/google/latest/docs/guides/provider_versions)) - config for secret sync auto rotation. Structure is [docuemented below](#sync_rotation_config)

<a name="sync_rotation_config"></a>The `rotation_config` block supports:

* `enabled` (Optional, [Beta](https://registry.terraform.io/providers/hashicorp/google/latest/docs/guides/provider_versions)) - Enable the roation in Sync as K8s secret feature for this cluster.
* `rotation_interval` (Optional, [Beta](https://registry.terraform.io/providers/hashicorp/google/latest/docs/guides/provider_versions)) - The interval between two consecutive rotations. Default rotation interval is 2 minutes.
...
* `workload_config` - (Optional, [Beta](https://registry.terraform.io/providers/hashicorp/google/latest/docs/guides/provider_versions)) WorkloadConfig defines which actions are enabled for a cluster's workload configurations. Structure is [documented below](#nested_workload_config)

* `workload_vulnerability_mode` - (Optional, [Beta](https://registry.terraform.io/providers/hashicorp/google/latest/docs/guides/provider_versions)) Sets which mode to use for Protect workload vulnerability scanning feature. Accepted values are DISABLED, BASIC.

<a name="nested_workload_config"></a>The `protect_config.workload_config` block supports:

* `audit_mode` - (Optional, [Beta](https://registry.terraform.io/providers/hashicorp/google/latest/docs/guides/provider_versions)) Sets which mode of auditing should be used for the cluster's workloads. Accepted values are DISABLED, BASIC.
