...
func serviceUsageOperationWait(d *schema.ResourceData, config *Config, op *serviceusage.Operation, project, activity, userAgent string, timeout time.Duration) error {
	...
	return serviceUsageOperationWaitTime(d, config, m, project, activity, userAgent, timeout)
}
