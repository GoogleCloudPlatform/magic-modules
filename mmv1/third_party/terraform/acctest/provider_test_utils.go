...
// GetTestRegion has the same logic as the provider's tpgresource.GetRegion, to be used in tests.
...
// GetTestProject has the same logic as the provider's tpgresource.GetProject, to be used in tests.
