...
func TestAccSdkProvider_terraform_attribution_label_addition_strategy(t *testing.T) {
	testCases := map[string]func(t *testing.T){
		...
		"when terraform_attribution_label_addition_strategy is unset in the config, the default value is set on the provider meta data": testAccSdkProvider_terraform_attribution_label_addition_strategy_defaultValue,
	}
