...
func disableServiceUsageProjectService(service, project string, d *schema.ResourceData, config *transport_tpg.Confignfig, disableDependentServices bool) error {
