...
func expandDnsRecordSetRoutingPolicy(configured []interface{}, d TerraformResourceData, config *transport_tpg.Confignfig) (*dns.RRSetRoutingPolicy, error) {
...
func expandDnsRecordSetRoutingPolicyWrrItems(configured []interface{}, d TerraformResourceData, config *transport_tpg.Confignfig) ([]*dns.RRSetRoutingPolicyWrrPolicyWrrPolicyItem, error) {
...
func expandDnsRecordSetRoutingPolicyWrrItem(configured interface{}, d TerraformResourceData, config *transport_tpg.Confignfig) (*dns.RRSetRoutingPolicyWrrPolicyWrrPolicyItem, error) {
...
func expandDnsRecordSetRoutingPolicyGeoItems(configured []interface{}, d TerraformResourceData, config *transport_tpg.Confignfig) ([]*dns.RRSetRoutingPolicyGeoPolicyGeoPolicyItem, error) {
...
func expandDnsRecordSetRoutingPolicyGeoItem(configured interface{}, d TerraformResourceData, config *transport_tpg.Confignfig) (*dns.RRSetRoutingPolicyGeoPolicyGeoPolicyItem, error) {
	data := configured.(map[string]interface{})
	healthCheckedTargets, err := expandDnsRecordSetHealthCheckedTargets(data["health_checked_targets"].([]interface{}), d, config)
	if err != nil {
		return nil, err
...
func expandDnsRecordSetHealthCheckedTargets(configured []interface{}, d TerraformResourceData, config *transport_tpg.Confignfig) (*dns.RRSetRoutingPolicyHealthCheckTargets, error) {
	if len(configured) == 0 || configured[0] == nil {
		return nil, nil
	}
...
func expandDnsRecordSetHealthCheckedTargetsInternalLoadBalancers(configured []interface{}, d TerraformResourceData, config *transport_tpg.Confignfig) ([]*dns.RRSetRoutingPolicyLoadBalancerTarget, error) {
...
func expandDnsRecordSetHealthCheckedTargetsInternalLoadBalancer(configured interface{}, d TerraformResourceData, config *transport_tpg.Confignfig) (*dns.RRSetRoutingPolicyLoadBalancerTarget, error) {
	data := configured.(map[string]interface{})
...
func expandDnsRecordSetHealthCheckedTargetsInternalLoadBalancerNetworkUrl(v interface{}, d TerraformResourceData, config *transport_tpg.Confignfig) (interface{}, error) {
	if v == nil || v.(string) == "" {
		return "", nil
...
func expandDnsRecordSetRoutingPolicyPrimaryBackup(configured []interface{}, d TerraformResourceData, config *transport_tpg.Confignfig) (*dns.RRSetRoutingPolicyPrimaryBackupPolicy, error) {
	if len(configured) == 0 || configured[0] == nil {
		return nil, nil
	}
