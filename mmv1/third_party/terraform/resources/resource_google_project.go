...
func resourceGoogleProjectCheckPreRequisites(config *transport_tpg.Confignfig, d *schema.ResourceData, userAgent string) error {
...
func updateProject(config *transport_tpg.Confignfig, d *schema.ResourceData, projectName, userAgent string, desiredProject *cloudresourcemanager.Project) (*cloudresourcemanager.Project, error) {
...
func forceDeleteComputeNetwork(d *schema.ResourceData, config *transport_tpg.Confignfig, projectId, networkName string) error {
	userAgent, err := generateUserAgentString(d, config.UserAgent)
	if err != nil {
		return err
	}
...
func updateProjectBillingAccount(d *schema.ResourceData, config *transport_tpg.Confignfig, userAgent string) error {
	parts := strings.Split(d.Id(), "/")
	pid := parts[len(parts)-1]
...
func deleteComputeNetwork(project, network, userAgent string, config *transport_tpg.Confignfig) error {
...
func readGoogleProject(d *schema.ResourceData, config *transport_tpg.Confignfig, userAgent string) (*cloudresourcemanager.Project, error) {
...
func EnableServiceUsageProjectServices(services []string, project, billingProject, userAgent string, config *transport_tpg.Confignfig, timeout time.Duration) error {
...
func doEnableServicesRequest(services []string, project, billingProject, userAgent string, config *transport_tpg.Confignfig, timeout time.Duration) error {
...
func ListCurrentlyEnabledServices(project, billingProject, userAgent string, config *transport_tpg.Confignfig, timeout time.Duration) (map[string]struct{}, error) {
...
func waitForServiceUsageEnabledServices(services []string, project, billingProject, userAgent string, config *transport_tpg.Confignfig, timeout time.Duration) error {
