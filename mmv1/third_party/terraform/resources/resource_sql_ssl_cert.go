...
func resourceSqlSslCertCreate(d *schema.ResourceData, meta interface{}) error {
	...
	err = sqlAdminOperationWaitTime(d, config, resp.Operation, project, "Create Ssl Cert", userAgent, d.Timeout(schema.TimeoutCreate))
	if err != nil {
...
func resourceSqlSslCertDelete(d *schema.ResourceData, meta interface{}) error {
	...
	err = sqlAdminOperationWaitTime(d, config, op, project, "Delete Ssl Cert", userAgent, d.Timeout(schema.TimeoutDelete))
