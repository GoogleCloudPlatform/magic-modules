...
func TestAccStorageTransferJob_posixSource(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccStorageTransferJob_posixSource(acctest.GetTestProjectFromEnv(), testDataSinkName, testTransferJobDescription),
			},
			{
				ResourceName:      "google_storage_transfer_job.transfer_job",
				ImportState:       true,
...
func TestAccStorageTransferJob_posixSink(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccStorageTransferJob_posixSink(acctest.GetTestProjectFromEnv(), testDataSourceName, testTransferJobDescription),
			},
			{
				ResourceName:      "google_storage_transfer_job.transfer_job",
				ImportState:       true,
