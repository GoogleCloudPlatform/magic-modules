		...
		Steps: []resource.TestStep{
			{
				Config: testAccMonitoringSloForSli(
					randomSuffix,
					testAccMonitoringSloSli_requestBasedDistributionMinOnly()),
			},
			{
	...
	vcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				Config: testAccMonitoringSloForSli(
					randomSuffix,
					testAccMonitoringSloSli_windowBasedSliGoodTotalRatioThreshold_distributionCutMinOnly(),
				),
			},
			{
				ResourceName:      "google_monitoring_slo.test_slo",
	...
	vcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				Config: testAccMonitoringSloForSli(
					randomSuffix,
					testAccMonitoringSloSli_windowBasedSliMetricMeanRangeUpdateMinOnly(),
				),
			},
			{
				ResourceName:      "google_monitoring_slo.test_slo",
	...
	vcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				Config: testAccMonitoringSloForSli(
					randomSuffix,
					testAccMonitoringSloSli_windowBasedSliMetricSumRangeUpdateMinOnly(),
				),
			},
			{
				ResourceName:      "google_monitoring_slo.test_slo",
...
func testAccMonitoringSloSli_requestBasedDistributionMinOnly() string {
	return `
request_based_sli {
	distribution_cut {
...
func testAccMonitoringSloSli_windowBasedSliGoodTotalRatioThreshold_distributionCutMinOnly() string {
	return fmt.Sprintf(`
windows_based_sli {
  window_period = "2400s"
	good_total_ratio_threshold {
...
func testAccMonitoringSloSli_windowBasedSliMetricMeanRangeUpdateMinOnly() string {
	return `
windows_based_sli {
	window_period = "600s"
	metric_mean_in_range {
...
func testAccMonitoringSloSli_windowBasedSliMetricSumRangeUpdateMinOnly() string {
	return `
windows_based_sli {
	window_period = "600s"
	metric_sum_in_range {
