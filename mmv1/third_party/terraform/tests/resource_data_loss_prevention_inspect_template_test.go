...
func TestAccDataLossPreventionInspectTemplate_dlpInspectTemplateTemplateIdUpdate(t *testing.T) {
	t.Parallel()
...
func testAccDataLossPreventionInspectTemplate_dlpInspectTemplateTemplateIdUpdate(context map[string]interface{}) string {
	return Nprintf(`
...
func testAccDataLossPreventionInspectTemplate_dlpInspectTemplateTemplateIdUpdateOther(context map[string]interface{}) string {
	return Nprintf(`
resource "google_data_loss_prevention_inspect_template" "with_template_id" {
  parent = "projects/%{project}"
  description = "My description"
