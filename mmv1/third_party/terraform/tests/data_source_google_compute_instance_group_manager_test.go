...
func TestAccDataSourceGoogleComputeInstanceGroupManager(t *testing.T) {
	...
	igmName := "tf-tst-igm" + acctest.RandString(t, 6)

	context := map[string]interface{}{
		"zoneName":     zoneName,
		"igmName":      igmName,
		"baseName":     "tf-tst-igm-base" + acctest.RandString(t, 6),
		"poolName":     "tf-tst-pool" + acctest.RandString(t, 6),
		"templateName": "tf-tst-templt" + acctest.RandString(t, 6),
		"autoHealName": "tf-tst-ah-name" + acctest.RandString(t, 6),
	}
