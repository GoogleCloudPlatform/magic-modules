  ...
  mapOf(
    ...
    "auditmanager" to
      mapOf(
        ...
        "path" to "./google-beta/services/auditmanager",
      ),
    "backupdr" to
      mapOf(
        "name" to "backupdr",
    ...
    "colab" to
      mapOf("name" to "colab", "displayName" to "Colab", "path" to "./google-beta/services/colab"),
    "composer" to
      mapOf(
        "name" to "composer",
    ...
    "dns" to mapOf("name" to "dns", "displayName" to "Dns", "path" to "./google-beta/services/dns"),
    "documentai" to
      mapOf(
        "name" to "documentai",
    ...
    "iam2" to
      mapOf("name" to "iam2", "displayName" to "Iam2", "path" to "./google-beta/services/iam2"),
    "iam3" to
      mapOf("name" to "iam3", "displayName" to "Iam3", "path" to "./google-beta/services/iam3"),
    "iambeta" to
      mapOf(
        "name" to "iambeta",
    ...
    "iap" to mapOf("name" to "iap", "displayName" to "Iap", "path" to "./google-beta/services/iap"),
    "identityplatform" to
      mapOf(
    ...
    "kms" to mapOf("name" to "kms", "displayName" to "Kms", "path" to "./google-beta/services/kms"),
    "logging" to
      mapOf(
        "name" to "logging",
    ...
    "redis" to
      mapOf("name" to "redis", "displayName" to "Redis", "path" to "./google-beta/services/redis"),
    "resourcemanager" to
      mapOf(
    ...
    "sql" to mapOf("name" to "sql", "displayName" to "Sql", "path" to "./google-beta/services/sql"),
    "storage" to
      mapOf(
        "name" to "storage",
    ...
    "tags" to
      mapOf("name" to "tags", "displayName" to "Tags", "path" to "./google-beta/services/tags"),
    "tpuv2" to
      mapOf("name" to "tpuv2", "displayName" to "Tpuv2", "path" to "./google-beta/services/tpuv2"),
    "transcoder" to
      mapOf(
        "name" to "transcoder",
