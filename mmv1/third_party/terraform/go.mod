...
require (
	...
	github.com/hashicorp/terraform-exec v0.24.1-0.20260121172827-e91e9600ec9b // indirect
...
replace github.com/hashicorp/terraform-plugin-testing => github.com/hashicorp/terraform-plugin-testing v0.0.0-20260210142228-230f2314a441
