...
func TestAccDatastreamConnectionProfile_sshKey_update(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDatastreamConnectionProfile_sshKey_update(context, true, random_privkey_1, random_pubkey_1),
			},
			{
			...
			},
			{
				...
				Config: testAccDatastreamConnectionProfile_sshKey_update(context, true, random_privkey_2, random_pubkey_2),
			},
			{
				ResourceName:            "google_datastream_connection_profile.ssh_connectivity_profile",
				ImportState:             true,
			...
			{
				Config: testAccDatastreamConnectionProfile_sshKey_update(context, false, random_privkey_2, random_pubkey_2),
			},
		},
	})
}
