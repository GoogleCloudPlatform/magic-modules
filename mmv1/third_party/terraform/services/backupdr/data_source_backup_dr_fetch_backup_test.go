...
// Data source to find the generated DataSource ID
...
data "google_backup_dr_fetch_backups" "default" {
  ...
  # Extract DataSource ID from the name: projects/.../backupVaults/.../dataSources/{data_source_id}
  data_source_id  = element(split("/", element(data.google_backup_dr_data_source_references.all_refs.data_source_references, 0).data_source), 7)
  resource_type   = "%{resource_type}"
