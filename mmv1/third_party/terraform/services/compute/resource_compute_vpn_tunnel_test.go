...
func TestAccComputeVpnTunnel_routerWithSharedSecretWo(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					// todo(ramon) add correct check to ensure that the shared_secret_wo is not written to state
