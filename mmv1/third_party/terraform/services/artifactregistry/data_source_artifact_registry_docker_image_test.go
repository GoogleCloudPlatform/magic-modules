		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					checkDigestDataSources(
						resourceName+"Digest",
						"projects/cloudrun/locations/us/repositories/container/dockerImages/hello@sha256:latest",
					...
					// url safe docker name
					checkDigestDataSources(
						resourceName+"UrlDigest",
						"projects/go-containerregistry/locations/us/repositories/gcr.io/dockerImages/krane%2Fdebug@sha256:latest",
						"us-docker.pkg.dev/go-containerregistry/gcr.io/krane/debug:latest",
					),
