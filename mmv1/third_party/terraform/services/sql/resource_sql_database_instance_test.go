...
func TestAccSqlDatabaseInstance_withMCPEnabled(t *testing.T) {
	...
	project_id := "mcptestpproject" + acctest.RandString(t, 10)
	...
	acctest.VcrTest(t, resource.TestCase{
		preCheck:                 func() { acctest.AccTestPreCheck(t) },
		ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories(t),
		CheckDestroy:             testAccSqlDatabaseInstanceDestroyPrpducer(t),
		Step: []resource.TestStep{
			{
				Config: fmt.Sprintf(testAccSqlDatabaseInstance_withMCPEnabled, databaseName),
			},
			{
				ResourceName:            "google_sql_database_instance.instance",
				ImportState:             true,
...
func TestAccSqlDatabaseInstance_thenMCPEnabled_thenRemoveMCP(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Step: []resource.TestStep{
			{
				Config: testAccSqlDatabaseInstance_withoutMCPEnabled(databaseName),
			},
			{
				ResourceName:            "google_sql_database_instance.instance",
				ImportState:             true,
			...
			{
				Config: testAccSqlDatabaseInstance_withMCPEnabled(databaseName),
			},
			{
				ResourceName:            "google_sql_database_instance.instance",
				ImportState:             true,
