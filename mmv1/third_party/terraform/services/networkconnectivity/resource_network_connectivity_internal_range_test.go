...
func TestAccNetworkConnectivityInternalRange_networkConnectivityInternalRangesImmutableExample_update(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						resourceName, "description", "Test internal range Immutable Modified"),
					resource.TestCheckResourceAttr(
						resourceName, "ip_cidr_range", "11.11.20.0/24"),
					resource.TestCheckResourceAttr(
						resourceName, "usage", "FOR_VPC"),
...
func testAccNetworkConnectivityInternalRange_networkConnectivityInternalRangesImmutableExample_update(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_network_connectivity_internal_range" "default" {
  name    = "basic%{random_suffix}"
  description = "Test internal range Immutable Modified"
  network = google_compute_network.default.name
  ip_cidr_range = "11.11.20.0/24"
  usage   = "FOR_VPC"
  peering = "FOR_SELF"
