...
<<<<<<< HEAD:mmv1/third_party/terraform/tests/resource_storage_default_object_access_control_test.go
...
=======
	...
	acctest.VcrTest(t, resource.TestCase{
>>>>>>> 12945f953 (Generate Mmv1 test files to the service packages):mmv1/third_party/terraform/services/storage/resource_storage_default_object_access_control_test.go
>>>>>>> c13a90bef (Generate Mmv1 test files to the service packages):mmv1/third_party/terraform/services/storage/resource_storage_default_object_access_control_test.go
		PreCheck: func() {
			if errObjectAcl != nil {
				panic(errObjectAcl)
			}
