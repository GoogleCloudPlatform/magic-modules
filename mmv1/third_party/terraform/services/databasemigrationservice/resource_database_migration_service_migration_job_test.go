...
func TestAccDatabaseMigrationServiceMigrationJob_postgresOld(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDatabaseMigrationServiceMigrationJob_postgresOld(context),
			},
			{
...
func testAccDatabaseMigrationServiceMigrationJob_postgresOld(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_sql_database_instance" "source_csql" {
...
resource "google_database_migration_service_connection_profile" "source_cp" {
  ...
  display_name          = "tf-test-src-cp%{random_suffix}_display"
  labels = {
    foo = "bar"
  }
  postgresql {
    ...
    cloud_sql_id = google_sql_database_instance.source_csql.name
  }
...
resource "google_database_migration_service_connection_profile" "destination_cp" {
  ...
  display_name          = "tf-test-dest-cp%{random_suffix}_display"
  labels = {
    foo = "bar"
  }
  postgresql {
    cloud_sql_id = google_sql_database_instance.destination_csql.name
  }
  depends_on = [google_sql_database_instance.destination_csql]
}
...
resource "google_database_migration_service_migration_job" "psql_to_psql" {
  ...
  display_name = "tf-test-mj-psql%{random_suffix}_display"
  labels = {
    foo = "bar"
  }
  static_ip_connectivity {
