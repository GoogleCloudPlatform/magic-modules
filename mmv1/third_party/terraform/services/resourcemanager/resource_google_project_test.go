		...
		Steps: []resource.TestStep{
			// This step creates a new project
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					acctest.GetTestMetadataForTgc("resourcemanager", "google_project", "acceptance", testAccProject_createWithoutOrg(pid)),
				),
			},
		},
	})
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// This step creates a new project
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckGoogleProjectExists("google_project.acceptance", pid),
					acctest.GetTestMetadataForTgc("resourcemanager", "google_project", "acceptance", testAccProject(pid, org)),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			...
			// Update to a different  billing account
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					acctest.GetTestMetadataForTgc("resourcemanager", "google_project", "acceptance", testAccProject_createBilling(pid, org, billingId2)),
				),
			},
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					acctest.GetTestMetadataForTgc("resourcemanager", "google_project", "acceptance", testAccProject_labels(pid, org, map[string]string{"test": "that"})),
				),
			},
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					acctest.GetTestMetadataForTgc("resourcemanager", "google_project", "acceptance", testAccProject_deleteDefaultNetwork(pid, org, billingId)),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					acctest.GetTestMetadataForTgc("resourcemanager", "google_project", "acceptance", testAccProject_parentFolder(pid, folderDisplayName, org)),
				),
			},
		},
	})
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				Config: testAccProject_migrateParentFolder(pid, folderDisplayName, org),
				Check: resource.ComposeTestCheckFunc(
					acctest.GetTestMetadataForTgc("resourcemanager", "google_project", "acceptance", testAccProject_migrateParentFolder(pid, folderDisplayName, org)),
				),
			},
			{
				ResourceName:            "google_project.acceptance",
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					acctest.GetTestMetadataForTgc("resourcemanager", "google_project", "acceptance", testAccProject_tagsAllowDestroy(pid, org, map[string]string{org + "/" + tagKey: tagValue})),
				),
			},
		},
	})
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckGoogleProjectExists("google_project.acceptance", pid),
					acctest.GetTestMetadataForTgc("resourcemanager", "google_project", "acceptance", testAccProject_abandon(pid, org)),
				),
			},
		},
	})
