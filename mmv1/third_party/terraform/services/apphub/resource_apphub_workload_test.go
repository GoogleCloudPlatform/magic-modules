...
func TestAccApphubWorkload_apphubWorkloadUpdate(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccApphubWorkload_apphubWorkloadUpdateCriticality(context),
			},
			{
				ResourceName:            "google_apphub_workload.example",
				ImportState:             true,
			...
			{
				Config: testAccApphubWorkload_apphubWorkloadUpdateOwners(context),
			},
			{
				ResourceName:            "google_apphub_workload.example",
				ImportState:             true,
...
func testAccApphubWorkload_apphubWorkloadUpdateCriticality(context map[string]interface{}) string {
...
func testAccApphubWorkload_apphubWorkloadUpdateOwners(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_apphub_application" "application" {
  location = "us-east1"
  application_id = "tf-test-example-application-1%{random_suffix}"
