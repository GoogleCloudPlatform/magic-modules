...
func TestAccApphubService_serviceUpdate(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccApphubService_apphubServiceUpdateCriticality(context),
			},
			{
				ResourceName:            "google_apphub_service.example",
				ImportState:             true,
			...
			{
				Config: testAccApphubService_apphubServiceUpdateOwners(context),
			},
			{
				ResourceName:            "google_apphub_service.example",
				ImportState:             true,
...
func testAccApphubService_apphubServiceUpdateCriticality(context map[string]interface{}) string {
...
func testAccApphubService_apphubServiceUpdateOwners(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_apphub_application" "application" {
  location = "us-east1"
  application_id = "tf-test-example-application-1%{random_suffix}"
