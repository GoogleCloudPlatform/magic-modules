...
import (
	...
	"github.com/GoogleCloudPlatform/terraform-google-conversion/v6/pkg/tfplan2cai/converters/transport"
...
func Convert(ctx context.Context, jsonPlan []byte, o *Options) ([]caiasset.Asset, error) {
	...
	for _, resourceDataList := range resourceDataMap {
		convertedAssets, err := converters.ConvertResource(resourceDataList, cfg, ancestryManager)
		if err != nil {
