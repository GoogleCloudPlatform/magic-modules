...
3.  **Verify before a PR:** generate, build, and run the tests relevant to the change. Verification fails if any step cannot be executed (e.g. due to missing permissions). A task is not done because it compiles.
