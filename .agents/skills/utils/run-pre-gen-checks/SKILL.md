...
description: "Run fast static checks that don't require generating downstreams, including gofmt formatting, template validation (version-guard and unused-tmpl), mmv1 core unit tests, and internal tool unit tests. Use this skill as a fast initial check for any changes."
---
