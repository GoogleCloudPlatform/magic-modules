...
description: "Workflow for diagnosing, fixing, and verifying failing Terraform acceptance tests from GitHub issues, direct prompts, or log files using Failure Scenario Decision Trees."
---
...
#### Path A: Automated Subagent (Default)
...
* If requested by the user, invoke the `create-pr` skill (`.agents/skills/operations/create-pr/`) to open a pull request.
