...
class Tiers < Inspec.resource(1)
  ...
  filter_table_config.add(:disk_quotas, field: :disk_quota)
  filter_table_config.add(:rams, field: :ram)
...
def url
  ...
  def fetch_data
    @data = fetch_wrapped_resource('sql#tier', 'sql#tiersList', 'items')
  end
