...
class Tier < Inspec.resource(1)

  name 'google_sql_tier'
  desc 'Tier'
  supports platform: 'gcp2'

  attr_reader :disk_quota
  attr_reader :ram
  attr_reader :region
  ...
  def initialize(params) 
    @fetched = fetch_wrapped_resource(params, 'sql#tier', 'sql#tiersList', 'items')
    parse unless @fetched.nil?
  end

  def parse
    @disk_quota = @fetched['DiskQuota']
    @ram = @fetched['RAM']
