...
class Instances < Inspec.resource(1)
  ...
  name 'google_sql_instances'
  desc 'Instance plural'
  ...
  filter_table_config.add(:database_versions, field: :database_version)
  ...
  filter_table_config.add(:ipv6_address, field: :ipv6_address)
...
def url
  ...
  def fetch_data
    @data = fetch_wrapped_resource('sql#instance', 'sql#instancesList', 'items')
  end
