...
class HttpHealthChecks < Inspec.resource(1)

  name 'google_compute_httphealthchecks'
  desc 'HttpHealthCheck plural'
...
def url
  ...
  def fetch_data
    @data = fetch_wrapped_resource('compute#httpHealthCheck', 'compute#autoscalerList', 'items')
  end
