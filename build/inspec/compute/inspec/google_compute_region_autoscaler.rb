...
require 'google/compute/property/regionautoscaler_cpu_utilization'
require 'google/compute/property/regionautoscaler_custom_metric_utilizations'
require 'google/compute/property/regionautoscaler_load_balancing_utilization'
require 'google/hash_utils'
require 'inspec/resource'

# A provider to manage Google Compute Engine resources.
class RegionAutoscaler < Inspec.resource(1)

  name 'google_compute_regionautoscaler'
  ...
  def parse
    ...
    @autoscaling_policy = Google::Compute::Property::RegionAutoscalerAutoscalingPolicy.new(@fetched['autoscalingPolicy'])
