...
class SslCertificates < Inspec.resource(1)

  name 'google_compute_sslcertificates'
  desc 'SslCertificate plural'
...
def url
  ...
  def fetch_data
    @data = fetch_wrapped_resource('compute#sslCertificate', 'compute#autoscalerList', 'items')
  end
