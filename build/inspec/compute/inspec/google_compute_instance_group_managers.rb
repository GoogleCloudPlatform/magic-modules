...
class InstanceGroupManagers < Inspec.resource(1)

  name 'google_compute_instancegroupmanagers'
  desc 'InstanceGroupManager plural'
...
def url
  ...
  def fetch_data
    @data = fetch_wrapped_resource('compute#instanceGroupManager', 'compute#autoscalerList', 'items')
  end
