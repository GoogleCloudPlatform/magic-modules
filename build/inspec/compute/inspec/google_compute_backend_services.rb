...
class BackendServices < Inspec.resource(1)

  name 'google_compute_backendservices'
  desc 'BackendService plural'
  ...
  filter_table_config.add(:cdn_policys, field: :cdn_policy)
  ...
  filter_table_config.add(:session_affinitys, field: :session_affinity)
...
def url
  ...
  def fetch_data
    @data = fetch_wrapped_resource('compute#backendService', 'compute#autoscalerList', 'items')
  end
