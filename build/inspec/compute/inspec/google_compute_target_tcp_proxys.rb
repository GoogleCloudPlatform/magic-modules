...
class TargetTcpProxys < Inspec.resource(1)

  name 'google_compute_targettcpproxys'
  desc 'TargetTcpProxy plural'
...
def url
  ...
  def fetch_data
    @data = fetch_wrapped_resource('compute#targetTcpProxy', 'compute#autoscalerList', 'items')
  end
