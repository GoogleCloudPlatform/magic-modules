...
class GlobalAddresss < Inspec.resource(1)

  name 'google_compute_globaladdresss'
  desc 'GlobalAddress plural'
...
def url
  ...
  def fetch_data
    @data = fetch_wrapped_resource('compute#address', 'compute#autoscalerList', 'items')
  end
