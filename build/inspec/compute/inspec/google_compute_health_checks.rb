...
class HealthChecks < Inspec.resource(1)

  name 'google_compute_healthchecks'
  desc 'HealthCheck plural'
...
def url
  ...
  def fetch_data
    @data = fetch_wrapped_resource('compute#healthCheck', 'compute#autoscalerList', 'items')
  end
