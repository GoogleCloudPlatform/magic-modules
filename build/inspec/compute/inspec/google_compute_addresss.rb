...
class Addresss < Inspec.resource(1)

  name 'google_compute_addresss'
  desc 'Address plural'
  supports platform: 'gcp2'

  filter_table_config = FilterTable.create
  filter_table_config.add(:address, field: :address)
...
def url
  ...
  def fetch_data
    @data = fetch_wrapped_resource('compute#address', 'compute#addressList', 'items')
  end
