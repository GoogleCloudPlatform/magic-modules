...
class TargetPools < Inspec.resource(1)

  name 'google_compute_targetpools'
  desc 'TargetPool plural'
...
def url
  ...
  def fetch_data
    @data = fetch_wrapped_resource('compute#targetPool', 'compute#autoscalerList', 'items')
  end
