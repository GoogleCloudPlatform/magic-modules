...
class RegionDiskTypes < Inspec.resource(1)

  name 'google_compute_regiondisktypes'
  desc 'RegionDiskType plural'
...
def url
  ...
  def fetch_data
    @data = fetch_wrapped_resource('compute#diskType', 'compute#autoscalerList', 'items')
  end
