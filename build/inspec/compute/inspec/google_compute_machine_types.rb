...
class MachineTypes < Inspec.resource(1)

  name 'google_compute_machinetypes'
  desc 'MachineType plural'
...
def url
  ...
  def fetch_data
    @data = fetch_wrapped_resource('compute#machineType', 'compute#autoscalerList', 'items')
  end
