...
class VpnTunnels < Inspec.resource(1)

  name 'google_compute_vpntunnels'
  desc 'VpnTunnel plural'
  ...
  filter_table_config.add(:shared_secret_hashs, field: :shared_secret_hash)
...
def url
  ...
  def fetch_data
    @data = fetch_wrapped_resource('compute#vpnTunnel', 'compute#autoscalerList', 'items')
  end
