...
class MachineType < Inspec.resource(1)

  name 'google_compute_machinetype'
  desc 'MachineType'
  ...
  def initialize(params) 
    @fetched = fetch_resource(params, 'compute#machineType')
    parse unless @fetched.nil?
  end  

  def parse
    @creation_timestamp = @fetched['creationTimestamp']
    @deprecated = Google::Compute::Property::MachineTypeDeprecated.new(@fetched['deprecated'])
