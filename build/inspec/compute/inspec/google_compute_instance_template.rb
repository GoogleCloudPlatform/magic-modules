...
class InstanceTemplate < Inspec.resource(1)

  name 'google_compute_instancetemplate'
  ...
  def initialize(params) 
    @fetched = fetch_resource(params, 'compute#instanceTemplate')
  ...
  def parse
    ...
    @id = @fetched['id']
    @name = @fetched['name']
    @properties = Google::Compute::Property::InstanceTemplateProperties.new(@fetched['properties'])
  end
