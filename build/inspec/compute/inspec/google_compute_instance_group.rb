...
class InstanceGroup < Inspec.resource(1)

  name 'google_compute_instancegroup'
  desc 'InstanceGroup'
  ...
  def initialize(params) 
    @fetched = fetch_resource(params, 'compute#instanceGroup')
  ...
  def parse
    ...
    @id = @fetched['id']
    @name = @fetched['name']
    @named_ports = Google::Compute::Property::InstanceGroupNamedPortsArray.parse(@fetched['namedPorts'])
