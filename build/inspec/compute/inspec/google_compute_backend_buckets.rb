...
class BackendBuckets < Inspec.resource(1)

  name 'google_compute_backendbuckets'
  desc 'BackendBucket plural'
...
def url
  ...
  def fetch_data
    @data = fetch_wrapped_resource('compute#backendBucket', 'compute#autoscalerList', 'items')
  end
