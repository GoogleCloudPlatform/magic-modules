...
class HealthCheck < Inspec.resource(1)

  name 'google_compute_healthcheck'
  desc 'HealthCheck'
  ...
  def initialize(params) 
    @fetched = fetch_resource(params, 'compute#healthCheck')
  ...
  def parse
    ...
    @type = @fetched['type']
    @http_health_check = Google::Compute::Property::HealthCheckHttpHealthCheck.new(@fetched['httpHealthCheck'])
    @https_health_check = Google::Compute::Property::HealthCheckHttpsHealthCheck.new(@fetched['httpsHealthCheck'])
    @tcp_health_check = Google::Compute::Property::HealthCheckTcpHealthCheck.new(@fetched['tcpHealthCheck'])
    @ssl_health_check = Google::Compute::Property::HealthCheckSslHealthCheck.new(@fetched['sslHealthCheck'])
  end
