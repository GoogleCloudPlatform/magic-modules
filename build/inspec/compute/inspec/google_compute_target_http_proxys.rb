...
class TargetHttpProxys < Inspec.resource(1)

  name 'google_compute_targethttpproxys'
  desc 'TargetHttpProxy plural'
...
def url
  ...
  def fetch_data
    @data = fetch_wrapped_resource('compute#targetHttpProxy', 'compute#autoscalerList', 'items')
  end
