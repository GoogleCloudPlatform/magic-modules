...
class TargetVpnGateways < Inspec.resource(1)

  name 'google_compute_targetvpngateways'
  desc 'TargetVpnGateway plural'
...
def url
  ...
  def fetch_data
    @data = fetch_wrapped_resource('compute#targetVpnGateway', 'compute#autoscalerList', 'items')
  end
