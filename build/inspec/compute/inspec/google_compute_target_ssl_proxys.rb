...
class TargetSslProxys < Inspec.resource(1)

  name 'google_compute_targetsslproxys'
  desc 'TargetSslProxy plural'
...
def url
  ...
  def fetch_data
    @data = fetch_wrapped_resource('compute#targetSslProxy', 'compute#autoscalerList', 'items')
  end
