...
class InstanceTemplates < Inspec.resource(1)

  name 'google_compute_instancetemplates'
  desc 'InstanceTemplate plural'
...
def url
  ...
  def fetch_data
    @data = fetch_wrapped_resource('compute#instanceTemplate', 'compute#autoscalerList', 'items')
  end
