...
class Instances < Inspec.resource(1)
  ...
  filter_table_config.add(:metadatas, field: :metadata)
  ...
  filter_table_config.add(:status, field: :status)
...
def url
  ...
  def fetch_data
    @data = fetch_wrapped_resource('compute#instance', 'compute#autoscalerList', 'items')
  end
