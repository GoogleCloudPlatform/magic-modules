...
class ForwardingRules < Inspec.resource(1)

  name 'google_compute_forwardingrules'
  desc 'ForwardingRule plural'
  ...
  filter_table_config.add(:ip_address, field: :ip_address)
...
def url
  ...
  def fetch_data
    @data = fetch_wrapped_resource('compute#forwardingRule', 'compute#autoscalerList', 'items')
  end
