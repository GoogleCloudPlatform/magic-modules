...
class DiskType < Inspec.resource(1)

  name 'google_compute_disktype'
  desc 'DiskType'
  ...
  def initialize(params) 
    @fetched = fetch_resource(params, 'compute#diskType')
  ...
  def parse
    ...
    @deprecated = Google::Compute::Property::DiskTypeDeprecated.new(@fetched['deprecated'])
