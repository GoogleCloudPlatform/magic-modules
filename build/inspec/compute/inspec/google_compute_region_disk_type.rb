...
class RegionDiskType < Inspec.resource(1)

  name 'google_compute_regiondisktype'
  desc 'RegionDiskType'
  ...
  def parse
    ...
    @deprecated = Google::Compute::Property::RegionDiskTypeDeprecated.new(@fetched['deprecated'])
