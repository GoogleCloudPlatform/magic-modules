...
class InstanceGroups < Inspec.resource(1)

  name 'google_compute_instancegroups'
  desc 'InstanceGroup plural'
...
def url
  ...
  def fetch_data
    @data = fetch_wrapped_resource('compute#instanceGroup', 'compute#autoscalerList', 'items')
  end
