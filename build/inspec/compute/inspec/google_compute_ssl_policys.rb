...
class SslPolicys < Inspec.resource(1)

  name 'google_compute_sslpolicys'
  desc 'SslPolicy plural'
...
def url
  ...
  def fetch_data
    @data = fetch_wrapped_resource('compute#sslPolicy', 'compute#autoscalerList', 'items')
  end
