...
class RegionAutoscalers < Inspec.resource(1)

  name 'google_compute_regionautoscalers'
  desc 'RegionAutoscaler plural'
  ...
  filter_table_config.add(:autoscaling_policys, field: :autoscaling_policy)
...
def url
  ...
  def fetch_data
    @data = fetch_wrapped_resource('compute#autoscaler', 'compute#autoscalerList', 'items')
  end
