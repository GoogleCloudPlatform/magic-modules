...
class HttpsHealthChecks < Inspec.resource(1)

  name 'google_compute_httpshealthchecks'
  desc 'HttpsHealthCheck plural'
...
def url
  ...
  def fetch_data
    @data = fetch_wrapped_resource('compute#httpsHealthCheck', 'compute#autoscalerList', 'items')
  end
