...
class TargetHttpsProxys < Inspec.resource(1)

  name 'google_compute_targethttpsproxys'
  desc 'TargetHttpsProxy plural'
...
def url
  ...
  def fetch_data
    @data = fetch_wrapped_resource('compute#targetHttpsProxy', 'compute#autoscalerList', 'items')
  end
