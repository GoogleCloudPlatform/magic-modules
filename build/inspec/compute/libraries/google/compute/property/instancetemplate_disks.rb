    ...
    module Property
      ...
      class InstanceTemplateDisks
        ...
        def initialize(args = nil) 
          ...
          @disk_encryption_key = Google::Compute::Property::InstanceTemplateDiskEncryptionKey.new(args['diskEncryptionKey'])
          @index = args['index']
          @initialize_params = Google::Compute::Property::InstanceTemplateInitializeParams.new(args['initializeParams'])
          @interface = args['interface']
          @mode = args['mode']
          @source = Google::Compute::Property::DiskNameRef.new(args['source'])
          @type = args['type']
        end
      end
