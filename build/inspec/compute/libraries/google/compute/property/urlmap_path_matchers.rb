    ...
    module Property
      ...
      class UrlMapPathMatchers
        ...
        def initialize(args = nil) 
          ...
          @default_service = Google::Compute::Property::BackendServiceSelfLinkRef.new(args['defaultService'])
          @description = args['description']
          @name = args['name']
          @path_rules = Google::Compute::Property::UrlMapPathRulesArray.parse(args['pathRules'])
        end
      end
