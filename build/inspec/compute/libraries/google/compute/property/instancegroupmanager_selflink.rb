...
module Google
  module Compute
    module Data
      ...
      # Imports self_link from instance_group_manager
      class InstanceGroupManagerSelfLinkRef
        include Comparable

        def ==(other)
          return false unless other.is_a? InstanceGroupManagerSelfLinkRef
      ...
      class InstanceGroupManagerSelfLinkRefCatalog < InstanceGroupManagerSelfLinkRef
        ...
        def resource
          ...
          raise ArgumentError, "gcompute_instance_group_manager[#{@title}] required"
        end
      end

      # A class to manage a JSON blob from GCP API
      # Will immediately return value from JSON blob without changes
      class InstanceGroupManagerSelfLinkRefApi < InstanceGroupManagerSelfLinkRef
    ...
    module Property
      # A class to manage fetching self_link from a instance_group_manager
      class InstanceGroupManagerSelfLinkRef
        ...
        def self.catalog_parse(value, parent_resource = nil)
          return if value.nil?
          return value if value.is_a? Data::InstanceGroupManagerSelfLinkRef
          Data::InstanceGroupManagerSelfLinkRefCatalog.new(value, parent_resource)
        end
        ...
        def self.api_parse(value)
          return if value.nil?
          return value if value.is_a? Data::InstanceGroupManagerSelfLinkRef
          Data::InstanceGroupManagerSelfLinkRefApi.new(value)
        end
      end
    end
  end
