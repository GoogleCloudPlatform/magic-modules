...
func TestExecVCRCassetteUpdate(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expectedCalls: map[string][]ParameterList{
				"Run": {
					{"/mock/dir/magic-modules/tools/magician", "gsutil", []string{"-m", "-q", "cp", "gs://ci-vcr-cassettes/beta/fixtures/*", "/mock/dir/magic-modules/tools/magician/cassettes/beta"}, map[string]string(nil)},
					{"/mock/dir/magic-modules/tools/magician", "gsutil", []string{"-m", "-q", "cp", "/mock/dir/magic-modules/tools/magician/cassettes/beta/*", "gs://vcr-nightly/beta/2024-07-08/buildID/main_cassettes_backup/fixtures/"}, map[string]string(nil)},
					{"/mock/dir/magic-modules/tools/magician", "git", []string{"clone", "https://hashicorp:token@github.com/hashicorp/terraform-provider-google-beta", "gopath/src/github.com/hashicorp/terraform-provider-google-beta"}, map[string]string(nil)},
					...
					{"gopath/src/github.com/hashicorp/terraform-provider-google-beta", "go", []string{"test", "", "-parallel", "32", "-v", "-run=TestAcc", "-timeout", "240m", "-ldflags=-X=github.com/hashicorp/terraform-provider-google-beta/version.ProviderVersion=acc", "-vet=off"}, map[string]string{
						...
						"GOOGLE_APPLICATION_CREDENTIALS": "/mock/dir/magic-modules/tools/magician/sa_key.json",
						"GOOGLE_CREDENTIALS":             "sa_key",
						"GOOGLE_TEST_DIRECTORY":          "",
						"SA_KEY":                         "sa_key",
						"TF_ACC":                         "1",
						"TF_LOG":                         "DEBUG",
						"TF_LOG_PATH_MASK":               "/mock/dir/magic-modules/tools/magician/testlogs/replaying/beta/%s.log",
						"TF_LOG_SDK_FRAMEWORK":           "INFO",
						"TF_SCHEMA_PANIC_ON_ERROR":       "1",
						"VCR_MODE":                       "REPLAYING",
						"VCR_PATH":                       "/mock/dir/magic-modules/tools/magician/cassettes/beta",
					}},
					{"/mock/dir/magic-modules/tools/magician", "gsutil", []string{"-h", "Content-Type:text/plain", "-q", "cp", "-r", "/mock/dir/magic-modules/tools/magician/testlogs/replaying_test.log", "gs://vcr-nightly/beta/2024-07-08/buildID/logs/replaying/"}, map[string]string(nil)},
					{"/mock/dir/magic-modules/tools/magician", "gsutil", []string{"-h", "Content-Type:text/plain", "-q", "cp", "-r", "/mock/dir/magic-modules/tools/magician/testlogs/replaying/beta/*", "gs://vcr-nightly/beta/2024-07-08/buildID/logs/build-log/"}, map[string]string(nil)},
				},
			},
		},
		{
			...
			expectedCalls: map[string][]ParameterList{
				"Run": {
					...
					{"gopath/src/github.com/hashicorp/terraform-provider-google-beta", "go", []string{"test", "", "-parallel", "1", "-v", "-run=TestAccContainerNodePool_defaultDriverInstallation$", "-timeout", "240m", "-ldflags=-X=github.com/hashicorp/terraform-provider-google-beta/version.ProviderVersion=acc", "-vet=off"}, map[string]string{
						...
						"TF_ACC":                         "1",
						"TF_LOG":                         "DEBUG",
						"TF_LOG_PATH_MASK":               "/mock/dir/magic-modules/tools/magician/testlogs/recording/beta/%s.log",
						"TF_LOG_SDK_FRAMEWORK":           "INFO",
						"TF_SCHEMA_PANIC_ON_ERROR":       "1",
						"VCR_MODE":                       "RECORDING",
						"VCR_PATH":                       "/mock/dir/magic-modules/tools/magician/cassettes/beta",
					}},
					{"/mock/dir/magic-modules/tools/magician", "gsutil", []string{"-h", "Content-Type:text/plain", "-q", "cp", "-r", "/mock/dir/magic-modules/tools/magician/testlogs/recording_test.log", "gs://vcr-nightly/beta/2024-07-08/buildID/logs/recording/"}, map[string]string(nil)},
					{"/mock/dir/magic-modules/tools/magician", "gsutil", []string{"-h", "Content-Type:text/plain", "-q", "cp", "-r", "/mock/dir/magic-modules/tools/magician/testlogs/recording/beta/*", "gs://vcr-nightly/beta/2024-07-08/buildID/logs/build-log/"}, map[string]string(nil)},
					{"/mock/dir/magic-modules/tools/magician", "gsutil", []string{"-m", "-q", "cp", "/mock/dir/magic-modules/tools/magician/cassettes/beta/*", "gs://ci-vcr-cassettes/beta/fixtures/"}, map[string]string(nil)},
				},
			},
		},
	}
