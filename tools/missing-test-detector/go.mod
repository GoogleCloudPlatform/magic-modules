...
replace google/provider/old => /usr/local/google/home/thomasrodgers/go/src/github.com/trodge/magic-modules/launch-generate-comment-go/tpgbold

replace google/provider/new => /usr/local/google/home/thomasrodgers/go/src/github.com/trodge/magic-modules/launch-generate-comment-go/tpgb
